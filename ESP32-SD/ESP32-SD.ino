...
//La librería SD usada en el ejemplo es diferente a la que tiene el ESP32. el esp32 usa shield y la libreria no
// Se trasladaron las funciones del ejemplo con la libreria del esp32
#include <FS.h>
#include <SD.h>

// #define FILE_WRITE (O_READ | O_WRITE | O_CREAT | O_APPEND) = 0X01 | 0X02 | 0X10 | 0X04 = 0x17
//Calculando la mascara para que realice la opreción de append que no viene incluida en este nueva libreria
//C:\Users\wes0439\AppData\Local\Arduino15\packages\{company}\hardware\samd\1.0.0\libraries\SD\src\utility\SdFat.h
#define FILE_OVERWRITE 0x52 // 0X40 (O_TRUNC) | 0X02 | 0X10 = 0x12 
...
// void renameFile(SDFileSystemClass &fs, const char * path1, const char * path2){
...
//   Serial.printf("SD Card Size: %lluMB\n", cardSize);
  ...
  appendFile(SD, "/hello.txt", "of the World!\n");
